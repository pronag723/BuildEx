-- =============================================================================
-- BuildEx - enforce the marketplace payment floor inside place_order
--
-- The rate editor already rejects prices below MIN_ORDER_CENTS, but a client
-- must never be able to bypass that rule by calling place_order directly.
-- NOWPayments' exact minimum is dynamic per currency pair; BuildEx keeps a
-- conservative marketplace floor and the invoice function performs the final
-- provider-side check before creating checkout.
-- =============================================================================
