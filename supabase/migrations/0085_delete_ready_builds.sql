-- Builders may permanently remove unsold ready-made listings. Deletion is
-- split in two so Storage objects are removed through the Storage API while
-- the ownership policy can still verify the listing owner.
