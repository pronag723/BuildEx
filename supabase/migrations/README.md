...
| 0093 | `0093_studio_ready_build_disclosures.sql` | **Studio ready-build publish fix.** Updates the required compatibility-disclosure RPC to authorize studio moderators through the shared listing-owner check, so studio drafts can be published. |
