...
export const legalDocuments = {
  ...
  privacy: {
    ...
    sections: [
      ...
      ["Your choices", ["Subject to local law, request access, correction, export, deletion, restriction, objection, or withdrawal of consent through privacy@buildex.builders. You may also complain to your data-protection authority. Identity verification may be required before fulfilling a request."]],
  ...
  community: {
    ...
    sections: [
      ...
      ["Reporting and moderation", ["Report scams, stolen builds, harassment, unsafe content, privacy violations, and underage-account concerns to support@buildex.builders with links and evidence. BuildEx may investigate, preserve evidence, restrict visibility, remove content, warn users, suspend accounts, or refer urgent matters to relevant authorities. Affected users may request an appeal."]],
      ["Copyright complaints", ["A rights holder may email copyright@buildex.builders with identification of the protected work, the allegedly infringing material and its location, contact details, a good-faith statement, an accuracy-and-authority statement, and a physical or electronic signature. BuildEx may forward the notice to the uploader and remove or restrict the content.", "A counter-notice should identify the removed material, state under penalty of perjury that removal resulted from mistake or misidentification, provide contact details and appropriate jurisdictional consent, and include a signature. BuildEx may restore material when legally permitted. Repeat infringers may be terminated."]],
