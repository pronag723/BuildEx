...
// Temporary emergency switch for buyer checkout. Keep this separate from
// PAYMENTS_ENABLED: that flag historically enabled a mock-payment fallback.
// Flip this one value to false and deploy to restore checkout.
...
/** Whether buyers may start a new order and be sent to checkout. */
export function checkoutAvailable() {
  return !CHECKOUT_PAUSED && PAYMENTS_ENABLED;
}
