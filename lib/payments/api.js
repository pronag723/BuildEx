...
//
// DORMANT BY DEFAULT: paymentsEnabled() gates the real Cryptomus flow on the
// NEXT_PUBLIC_PAYMENTS_ENABLED env flag. Until Cryptomus keys exist the flag is
...
// Create a Cryptomus checkout for an existing pending_payment order and return
