...
export const SERVER_TYPES = [
  { key: "survival",  label: "Survival",        icon: "globe" },
  { key: "smp",       label: "SMP / Community", icon: "handshake" },
  { key: "creative",  label: "Creative",        icon: "palette" },
  { key: "minigames", label: "Minigames",       icon: "gamepad" },
...
export const BUILDER_TOOLS = [
  { key: "worldedit",    label: "WorldEdit",    icon: "wand" },
  { key: "voxelsniper",  label: "VoxelSniper",  icon: "paintbrush" },
  { key: "axiom",        label: "Axiom",        icon: "axe" },
  { key: "arceon",       label: "Arceon",       icon: "sprout" },
  { key: "worldpainter", label: "WorldPainter", icon: "map" },
  { key: "litematica",   label: "Litematica",   icon: "ruler" },
  { key: "blockbench",   label: "BlockBench",   icon: "box" },
  { key: "photoshop",    label: "Photoshop",    icon: "image" },
  { key: "vanilla",      label: "Vanilla only", icon: "pickaxe" },
];

export function sanitizeBuilderTools(tools) {
  if (!Array.isArray(tools)) return [];
  const allowed = new Set(BUILDER_TOOLS.map(({ key }) => key));
  return tools.filter((key) => allowed.has(key));
}
...
export const PROJECT_TYPES = [
  { key: "commissions",    label: "Build commissions",      icon: "briefcase" },
  { key: "collaborations", label: "Collaborations",         icon: "users" },
  { key: "contests",       label: "Contests & events",      icon: "trophy" },
  { key: "longterm",       label: "Long-term partnerships", icon: "link" },
  { key: "quickjobs",      label: "Quick one-off jobs",     icon: "zap" },
];
