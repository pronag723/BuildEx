...
// Checkout offers only live low-fee USDT rails whose provider minimum fits the
// order. The Edge Function remains authoritative because those minimums change.
export const MIN_ORDER_CENTS = 500; // $5.00
