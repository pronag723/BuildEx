...
// NOWPayments minimum invoice amount varies by coin (query /v1/min-amount to get
// the exact value per currency). $20 is a safe conservative floor that keeps us
// above every network's threshold and is a sensible business minimum for build
// commissions. Enforced in the rate editor and in the create-invoice Edge Function.
