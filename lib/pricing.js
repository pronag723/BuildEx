...
// NOWPayments' exact minimum invoice amount is dynamic per currency pair and
// fee mode. Because BuildEx currently lets the buyer choose the pay currency,
// there is no single provider minimum to display while a builder edits rates.
// $20 is our conservative marketplace floor; the Edge Function performs the
// final provider-side validation when an invoice is created.
