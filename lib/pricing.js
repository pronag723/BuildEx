...
// NOWPayments minimum invoice amount varies by coin; $5 is a safe floor that
// keeps us above every network's threshold with room to spare. Enforced both in
// the rate editor (builder can't save a lower price) and in create-invoice (server
// rejects the invoice before calling the gateway).
